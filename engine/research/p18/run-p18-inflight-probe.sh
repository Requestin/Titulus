#!/usr/bin/env bash
# engine/research/p18/run-p18-inflight-probe.sh — Phase 18 P0.2 dual-BeginFrame probe.
#
...
#   ./engine/research/p18/run-p18-inflight-probe.sh --consumer=null --duration=60 \
