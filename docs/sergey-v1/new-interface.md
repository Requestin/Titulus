...
Иллюстрированное описание интерфейса, подготовленное Сергеем. Изображения
хранятся в [`new-interface-assets/media/`](new-interface-assets/media/).
...
>
> Описание параметров: [Crawl — параметры объекта и анимации](crawl-parameters.md).
...
> в параметр source описываем какой файл мы парсим, какая его структура и какие названия столбцов(параметров) мы его данным присваеваем. Далее создаем pipeline где мы можем присваивать переменным значения из этого файла. Подробности: [Template Editor → Data](template-editor-data.md).
